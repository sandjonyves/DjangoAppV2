...
return <div> {
   ...
   justify-center items-center ">
      <div className="card  md:w-[500px] w-[400px] max-[332px]:w-[300px] 
       rounded-md shadow-md bg-white  
         h-auto rounded-md shadow-md 
         bg-white p-2 md:my-5 md:mt-48 mt-20">
   ...
   <div>
      <div class={tabVars.ButValid}>
         <button  onClick={tabFunction.handleprev2} 
          class={tabVars.precButton} 
          type="button">
           prec
         </button>
    ...
    }
    {
        ...
        formNo === 5 && <div>
        <div className={tabVars.font}>
        <div className="card  md:w-[500px] w-[400px] max-[332px]:w-[300px]  rounded-md shadow-md bg-white    h-auto rounded-md shadow-md bg-white p-2 md:my-5 md:mt-48 mt-20">
